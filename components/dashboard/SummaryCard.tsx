...
const SummaryCard: React.FC<SummaryCardProps> = ({ title, amount, icon, trend, trendDirection, iconBgColor, iconColor }) => {
  ...
  return (
    <div className="bg-white dark:bg-neutral-900 p-6 rounded-2xl shadow-md flex flex-col justify-between h-full transition-transform duration-300 hover:scale-105 hover:shadow-xl">
      <div className="flex items-start space-x-4">
        ...
        <div>
          <p className="text-neutral-500 dark:text-neutral-400 text-sm h-10">{title}</p>
